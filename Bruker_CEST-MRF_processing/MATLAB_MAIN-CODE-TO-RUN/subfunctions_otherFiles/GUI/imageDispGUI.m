...
% ROI creation
uicontrol(bg1,'Style','text','Position',[30 540 80 15],...
    'String','New ROI name:');
nr=uicontrol(bg1,'Style','edit','Position',[30 515 80 20],...
    'String',newname,'Callback',@nameROI);
uicontrol(bg1,'Style','pushbutton','Position',[0 485 140 30],...
    'String','Draw new ROI on slice','Callback',@newROI);
uicontrol(bg1,'Style','pushbutton','Position',[0 450 140 30],...
    'String','Auto-detect tubes','Callback',@autoDetectROIs);

% Auto-detection parameters
uicontrol(bg1,'Style','text','Position',[5 425 150 15],...
    'String','Auto-detect parameters:','FontWeight','bold');
uicontrol(bg1,'Style','text','Position',[10 405 100 15],...
    'String','Gauss sigma:');
uicontrol(bg1,'Style','edit','Position',[30 385 80 20],...
    'String',num2str(settings.autoDetectGaussSigma),...
    'Tag','autoDetectGaussSigma','Callback',@editSettingVals);
uicontrol(bg1,'Style','text','Position',[10 360 120 15],...
    'String','Min tube pixels:');
uicontrol(bg1,'Style','edit','Position',[30 340 80 20],...
