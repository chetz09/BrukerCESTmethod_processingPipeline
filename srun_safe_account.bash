...
#SBATCH --partition=rtx8000,dgx-a100
...
# SAFE VERSION - Only uses partitions confirmed to work with cestmrf account
# Explicitly sets account and QOS to avoid permission issues
